...
params = '["-chardev", "spicevmc,id=charredir4,name=usbredir", "-device", "usb-redir,chardev=charredir4,id=redir4", "-chardev", "spicevmc,id=charredir5,name=usbredir", "-device", "usb-redir,chardev=charredir5,id=redir5"]'
