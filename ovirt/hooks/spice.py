...
spiceoptions = """
{'image':{'compression':'auto_glz'},'jpeg':{'compression':'always'},'zlib':{'compression':'never'},'playback':{'compression':'off'},'streaming':{'mode':'filter'}}
"""
os.environ.__setitem__("spiceoptions",spiceoptions)
def main():
